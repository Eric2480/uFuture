...
<head>
    ...
    <title> iNoteOA--欢迎使用iNoteOA系统 </title>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="/assets/img/1.jpg" alt="avatar" class="mw30 br64">
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/employee/list" id="list-1">
                                <span class="glyphicon glyphicon-calendar"></span> 所有员工 </a>
                        </li>
                        <li class="active">
                            <a href="/employee/to_add" id="add-1">
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/department/list" id="list">
                                <span class="glyphicon glyphicon-calendar"></span> 所有部门 </a>
                        </li>
                        <li class="active">
                            <a href="/department/to_add" id="add">
                ...
                <li>
                    <a class="accordion-toggle" href="#">
                        <span class="fa fa-columns"></span>
                        <span class="sidebar-title">更多功能</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/more">
                                <span class="glyphicon glyphicon-calendar"></span> 百宝箱 </a>
                        </li>
                    </ul>
                </li>
            </ul>
